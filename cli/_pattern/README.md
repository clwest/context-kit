...
|---|---|---|
| `spokesperson-corpus/` | A public-voice markdown corpus that grounds a spokesperson AI (example-agent-os, chat widget, support agent) in the project's source-of-truth — small embedding-friendly chunks with structured facts + pre-written voice prose + explicit off-limits | The project has a public-facing surface where an AI represents it to people who don't work on it |
