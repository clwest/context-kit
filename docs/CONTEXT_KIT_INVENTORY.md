...
<!-- Last generated: 2026-04-28T16:40:13+00:00 -->
<!-- Schema version: 1 -->
...
| Item | Count | Notes |
|---|---|---|
| CLI subcommands | 11 | adopt, audit, doctor, fix, hotpath, init, inventory, orient, recommend-stack, seed, start |
| Python modules in `cli/` | 13 | __init__.py, adopt.py, audit.py, bootstrap.py, doctor.py, fix.py, hotpath.py, inventory.py, orient.py, placeholders.py, recommend_stack.py, seed.py, server.py |
...
| Test files | 13 | `tests/test_*.py` |
| Tests collected | 520 | from `def test_` parse |
| Skill files | 2 | `skills/**/SKILL.md` |
| Tracked files | 88 | from `git ls-files` |
