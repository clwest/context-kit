...
<!-- Last generated: 2026-04-25T20:48:01+00:00 -->
<!-- Schema version: 1 -->
...
| Item | Count | Notes |
|---|---|---|
| CLI subcommands | 6 | hotpath, init, inventory, orient, seed, start |
| Python modules in `cli/` | 8 | __init__.py, bootstrap.py, hotpath.py, inventory.py, orient.py, placeholders.py, seed.py, server.py |
| Top-level guide docs | 8 | matches `0[1-8]_*.md` |
| `docs/` files (top-level) | 4 | excludes handoffs |
| Session handoffs | 4 | `docs/handoffs/` |
| Templates | 0 | `templates/` |
| Starter files (excl. scaffold) | 0 | `starter/` |
| Scaffold files | 0 | `starter/scaffold/` |
| Test files | 7 | `tests/test_*.py` |
| Tests collected | 127 | from `def test_` parse |
