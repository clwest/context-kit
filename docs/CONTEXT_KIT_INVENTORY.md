...
<!-- Last generated: 2026-05-02T01:03:24+00:00 -->
<!-- Schema version: 1 -->
...
| Item | Count | Notes |
|---|---|---|
| CLI subcommands | 14 | adopt, audit, doctor, exec, fix, hotpath, init, inspect, inventory, orient, recommend-stack, refactor, seed, start |
| Python modules in `cli/` | 16 | __init__.py, adopt.py, audit.py, bootstrap.py, doctor.py, exec.py, fix.py, hotpath.py, inspect.py, inventory.py, orient.py, placeholders.py, recommend_stack.py, refactor.py, seed.py, server.py |
...
| Tests collected | 736 | from `def test_` parse |
| Skill files | 2 | `skills/**/SKILL.md` |
| Tracked files | 111 | from `git ls-files` |
