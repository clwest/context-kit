...
<!-- Last generated: 2026-04-25T21:29:05+00:00 -->
<!-- Schema version: 1 -->
...
| Item | Count | Notes |
|---|---|---|
| CLI subcommands | 7 | doctor, hotpath, init, inventory, orient, seed, start |
| Python modules in `cli/` | 9 | __init__.py, bootstrap.py, doctor.py, hotpath.py, inventory.py, orient.py, placeholders.py, seed.py, server.py |
| Top-level guide docs | 8 | matches `0[1-8]_*.md` |
| `docs/` files (top-level) | 4 | excludes handoffs |
| Session handoffs | 5 | `docs/handoffs/` |
| Templates | 0 | `templates/` |
| Starter files (excl. scaffold) | 0 | `starter/` |
| Scaffold files | 0 | `starter/scaffold/` |
| Test files | 8 | `tests/test_*.py` |
| Tests collected | 167 | from `def test_` parse |
| Skill files | 2 | `skills/**/SKILL.md` |
| Tracked files | 67 | from `git ls-files` |
