...
<!-- Last generated: 2026-04-26T00:54:31+00:00 -->
<!-- Schema version: 1 -->
...
| Item | Count | Notes |
|---|---|---|
| CLI subcommands | 8 | doctor, hotpath, init, inventory, orient, recommend-stack, seed, start |
| Python modules in `cli/` | 10 | __init__.py, bootstrap.py, doctor.py, hotpath.py, inventory.py, orient.py, placeholders.py, recommend_stack.py, seed.py, server.py |
...
| Test files | 10 | `tests/test_*.py` |
| Tests collected | 227 | from `def test_` parse |
