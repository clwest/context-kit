...
<!-- Last generated: 2026-05-03T01:29:47+00:00 -->
<!-- Schema version: 1 -->
...
| Item | Count | Notes |
|---|---|---|
| CLI subcommands | 21 | adopt, audit, behavior, codex, connections, coverage, doctor, exec, fix, hotpath, init, inspect, inventory, orient, recommend-stack, refactor, seed, start, start-codex, translation-init, verify |
| Python modules in `cli/` | 22 | __init__.py, adopt.py, audit.py, behavior.py, bootstrap.py, connections.py, coverage.py, doctor.py, exec.py, fix.py, hotpath.py, inspect.py, inventory.py, orient.py, placeholders.py, recommend_stack.py, refactor.py, seed.py, server.py, start_codex.py, state.py, translation_init.py, verify.py |
...
| Tests collected | 821 | from `def test_` parse |
| Skill files | 2 | `skills/**/SKILL.md` |
| Tracked files | 118 | from `git ls-files` |
