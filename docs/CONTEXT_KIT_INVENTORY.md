...
<!-- Last generated: 2026-04-28T17:33:29+00:00 -->
<!-- Schema version: 1 -->
...
| Item | Count | Notes |
|---|---|---|
| CLI subcommands | 12 | adopt, audit, doctor, exec, fix, hotpath, init, inventory, orient, recommend-stack, seed, start |
| Python modules in `cli/` | 14 | __init__.py, adopt.py, audit.py, bootstrap.py, doctor.py, exec.py, fix.py, hotpath.py, inventory.py, orient.py, placeholders.py, recommend_stack.py, seed.py, server.py |
...
| Test files | 14 | `tests/test_*.py` |
| Tests collected | 546 | from `def test_` parse |
| Skill files | 2 | `skills/**/SKILL.md` |
| Tracked files | 93 | from `git ls-files` |
