...
<!-- Last generated: 2026-04-28T15:52:34+00:00 -->
<!-- Schema version: 1 -->
...
| Item | Count | Notes |
|---|---|---|
| CLI subcommands | 10 | adopt, audit, doctor, hotpath, init, inventory, orient, recommend-stack, seed, start |
| Python modules in `cli/` | 12 | __init__.py, adopt.py, audit.py, bootstrap.py, doctor.py, hotpath.py, inventory.py, orient.py, placeholders.py, recommend_stack.py, seed.py, server.py |
...
| Tests collected | 494 | from `def test_` parse |
