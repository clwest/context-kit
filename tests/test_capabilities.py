...
class TestCapabilitiesCommand(unittest.TestCase):
    ...
    def test_outputs_route_and_tier_evidence(self):
        ...
        self.assertIn("Meaning: Route evidence suggests user registration, login, and current-user lookup.", out)
        ...
        self.assertIn("Meaning: Route evidence suggests Stripe checkout support.", out)
        ...
        self.assertIn("Meaning: Route evidence suggests Stripe webhook handling.", out)
